...
// PSUEDO
// 1. define function with one arguemnet 
// 2. create a variable that adds a space between each work, capitalizes first letter, adda s period and joins into complete string 
// 3. Return the word/argument 
